...
// Хэрэв аль хэдийн нэвтэрсэн бол сонголтын хуудсанд явуулна
...
<head>
    <meta charset="UTF-8">
    <title>Нэвтрэх – WE MASTER</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Sora:wght@400;600;700;800&display=swap');
        :root {
            --accent: #00c6ff; --accent2: #00ff94;
            --bg: #0f2027; --surface: #203a43; --sidebar-bg: #2c5364;
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-submit:hover { transform: translateY(-1px); box-shadow: 0 6px 20px rgba(0,198,255,0.5); }
